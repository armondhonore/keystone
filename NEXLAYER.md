...
**Live:** [https://relaxed-weasel-keystone.cloud.nexlayer.ai](https://relaxed-weasel-keystone.cloud.nexlayer.ai)  
...
**keystone** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  - name: app
    ...
    - 3000
    vars:
      DATABASE_URL: "postgresql://keystone:${POSTGRES_PASSWORD}@postgres.pod:5432/keystone"
      SESSION_SECRET: "a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4"
    volumes:
    - name: keystone-data
      mountPath: /app/.keystone
      size: 5Gi
  - name: postgres
